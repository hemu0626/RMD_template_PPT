...
\addtobeamertemplate{frametitle}{}{%
	\begin{textblock*}{100mm}(.94\textwidth,-1.04cm)
		\includegraphics[height=1.0cm,width=2.0cm,keepaspectratio=TRUE]{stat-logo-white-1.png}
	\end{textblock*}}
	...
	\usebackgroundtemplate{% 
		\tikz\node[opacity=0.05,inner sep=0] {\includegraphics[height=\paperheight,width=\paperwidth,keepaspectratio=FALSE]{bdbg-2.jpg}};} % bdbg-1.jpeg
	
	%\titlegraphic{\includegraphics[width=3.0cm]{Shvad-Chi.png}}
	\titlegraphic{\includegraphics[width=2.2cm]{statlogo-02.png}} %stat-right.png
